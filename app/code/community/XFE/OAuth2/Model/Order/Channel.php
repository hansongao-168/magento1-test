 ...
 *
 * Class name MUST be XFE_OAuth2_Model_Order_Channel (two-word) so that
 * the alias `xfeoauth2/order_channel` resolves correctly via
 ...
 * @package    XFE_OAuth2
 */
class XFE_OAuth2_Model_Order_Channel extends Mage_Core_Model_Abstract
{
    /** @var string */
     ...
     * @return XFE_OAuth2_Model_Order_Channel
     */
