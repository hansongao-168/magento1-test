 ...
 */
class XFE_LogisticsCarriersLabel_Block_Adminhtml_Rule_Edit_Form extends Mage_Adminhtml_Block_Widget_Form
{
    protected function _prepareForm()
    {
        ...
        $fieldset->addField('tracking_url_template', 'textarea', array(
            ...
            'style' => 'height:60px;',
            'note'  => $helper->__('Use {tracking_number} and {zip} as placeholders.'),
        ));
        ...
        $fieldset->addField('background_color', 'text', array(
            ...
            'after_element_html' => '<input type="color" name="bg_color_picker" id="bg_color_picker" value="" onchange="document.getElementById(\'background_color\').value=this.value" style="width:40px;height:30px;padding:0;border:none;cursor:pointer;vertical-align:middle;margin-left:5px;" />',
        ));
        ...
        $fieldset->addField('text_color', 'text', array(
            ...
            'after_element_html' => '<input type="color" name="text_color_picker" id="text_color_picker" value="" onchange="document.getElementById(\'text_color\').value=this.value" style="width:40px;height:30px;padding:0;border:none;cursor:pointer;vertical-align:middle;margin-left:5px;" />',
        ));
