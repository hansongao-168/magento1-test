 ...
 */
class XFE_LogisticsCarriersLabel_Block_Adminhtml_Rule_Edit_Tab_Conditions extends Mage_Adminhtml_Block_Widget_Form
    implements Mage_Adminhtml_Block_Widget_Tab_Interface
{
    protected function _prepareForm()
    {
        ...
        $fieldset->addType('conditions_builder', 'XFE_LogisticsCarriersLabel_Block_Adminhtml_Rule_Edit_Renderer_Conditions');
    ...
    {
        return Mage::helper('xcarrierslabel')->__('Conditions');
    }
